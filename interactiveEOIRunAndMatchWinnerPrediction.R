...
while (TestSeasonSlice <= MaxTestSeasonData) {  
  ...
  winnerInn2AtOver26Model <- Over26winner_fun(matSummTrngInit) # predicting winner at the end of 26th over
  winnerInn2AtOver30Model <- Over30winner_fun(matSummTrngInit)
  winnerInn2AtOver35Model <- Over35winner_fun(matSummTrngInit)
