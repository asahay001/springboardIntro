...
3. Weather conditions can be added to the variable list to see how heat, humidity and rain influence teams' scores. 
4. Since data is compared across seasons for predicting winners, consider the following:
